...
const teams = [
  {
    name: "Leadership",
    members: [
      { name: "Lucky Pandey", year: "Captain", image: "" },
      { name: "Prachi Garg", year: "Vice Captain", image: "" },
    ],
  },
  {
    name: "Event Coordinators",
    members: [
      { name: "Aushika Jain", year: "Coordinator", image: "" },
      { name: "Manitarya Shivhare", year: "Coordinator", image: "" },
      { name: "Kashvi Agrawal", year: "Coordinator", image: "" },
      { name: "Mitanshu Singhal", year: "Coordinator", image: "" },
    ],
  },
  {
    name: "Sponsor Team",
    members: [
      { name: "Vidhi Ramnani", year: "Lead", image: "" },
      { name: "Suvanish Shringi", year: "Member", image: "" },
      { name: "Preksha Jain", year: "Member", image: "" },
      { name: "Asmi Jain", year: "Member", image: "" },
      { name: "Ravi Kumar", year: "Member", image: "" },
      { name: "Kritika Jain", year: "Member", image: "" },
      { name: "Tushar Singhal", year: "Member", image: "" },
    ],
  },
  {
    name: "Web Development",
    members: [
      { name: "Nayan Mathur", year: "Lead", image: "" },
      { name: "Pradyusha Chouhan", year: "Developer", image: "" },
      { name: "Parth Shrivastava", year: "Developer", image: "" },
      { name: "Gaurav Panwar", year: "Developer", image: "" },
    ],
  },
  {
    name: "Graphics & Design",
    members: [
      { name: "Nisha Lekhwani", year: "Lead", image: "" },
      { name: "Chetali Kumawat", year: "Designer", image: "" },
      { name: "Divya Chitlangiya", year: "Designer", image: "" },
      { name: "Sublamshi Singh", year: "Designer", image: "" },
      { name: "Kshitiz Patel", year: "Designer", image: "" },
    ],
  },
  {
    name: "Social Media & Marketing",
    members: [
      { name: "Prateek Sharma", year: "Lead", image: "" },
      { name: "Mudit Jain", year: "Manager", image: "" },
      { name: "Neeraj Singh", year: "Manager", image: "" },
    ],
  },
];
